...
const UICtrl = (function(){
  ...
  return {
    ...
    updateListItem(item){
      ...
      // Turn node list into array, forEach works with node list for a few things
      ...
      <div class="card-content">
        ...
        <form class="col">
          <div class="row">
            ...
            <button type="button" class="update-btn btn orange"><i class="fa fa-pencil-square-o"></i> Update Meal</button>
            <button type="button" class="delete-btn btn red"><i class="fa fa-remove"></i> Delete Meal</button>
            <!-- Make sure button type is button or else it automatically is submit and will refresh the page -->
            <button  type="button" class="back-btn btn grey pull-right"><i class="fa fa-chevron-circle-left"></i> Back</button>
          </div>
        </form>
      </div>
    </div>
